...
<head>
    ...
    <body>
        ...
        <main class=" container-fluid   p-4 text-center">
            <form class="d-flex flex-column mx-auto w-25 bg-light" action="{{ url('receber') }}" method="POST">
                <div class="container ">    
                    @csrf
                    <h2 class="text-success">Cadastro de Entrada</h2>
                    ...
                    <button id="btnSend" class="btn btn-success mt-5" type="submit">Criar de entrada</button>
                </div>
            </form>
        </main>
    </body>
